 ...
 */
export function enforceLimits(resource) {
    return async (req, res, next) => {
        try {
 ...
 */
export function validateTenantAccess(resourceTenantId, requestTenantId) {
    return resourceTenantId === requestTenantId;
}
/**
 * SQL query helper to automatically add tenant filtering
 */
export function addTenantFilter(baseQuery, tenantId) {
