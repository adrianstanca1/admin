...
import { Company, User, Project, Invoice, Expense } from '../types';

// Sample data for seeding
const companies: Omit<Company, 'created_at' | 'updated_at'>[] = [
  {
    id: 'comp-1',
...
const users: Omit<User, 'created_at' | 'updated_at' | 'password_hash'>[] = [
  {
    id: 'user-1',
...
const projects: Omit<Project, 'created_at' | 'updated_at'>[] = [
  {
    id: 'proj-1',
...
const invoices: Omit<Invoice, 'created_at' | 'updated_at'>[] = [
  {
    id: 'inv-1',
...
const expenses: Omit<Expense, 'created_at' | 'updated_at'>[] = [
  {
    id: 'exp-1',
    project_id: 'proj-1',
    company_id: 'comp-1',
