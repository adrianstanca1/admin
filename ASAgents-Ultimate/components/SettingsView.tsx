...
// FIX: Temporary types for failed sync actions (to be implemented)
interface FailedActionForUI {
  id: string;
  action: string;
  error: string;
  timestamp: string;
...
// FIX: Temporary implementations (to be replaced with real API)
const getFailedSyncActions = () => [];
const formatFailedActionForUI = (action: any): FailedActionForUI => action;
const retryFailedAction = async (id: string) => {};
const discardFailedAction = async (id: string) => {};
